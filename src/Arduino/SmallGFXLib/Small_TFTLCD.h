...
#ifndef _SMALL_TFTLCD_H_
#define _SMALL_TFTLCD_H_
...
//#define USE_SMALL_SHIELD_PINOUT 1

class Small_TFTLCD : public Small_GFX {

 public:

  Small_TFTLCD(uint8_t cs, uint8_t cd, uint8_t wr, uint8_t rd, uint8_t rst);
  Small_TFTLCD(void);
